...
$(document).on('click','#one',function () {
    $('html, body').animate({ scrollTop: (positions[ 1 ] - documentHeight + 10)}, 1000 );
});

$(document).on('click','#two',function () {
    $('html, body').animate({ scrollTop: (positions[ 2 ] - documentHeight + 10)}, 1000 );
});

$(document).on('click','#three',function () {
    $('html, body').animate({ scrollTop: (positions[ 3 ] - documentHeight + 10)}, 1000 );
});

$(document).on('click','#four',function () {
    $('html, body').animate({ scrollTop: (positions[ 4 ] - documentHeight + 10)}, 1000 );
});

$(document).on('click','#five',function () {
    $('html, body').animate({ scrollTop: (positions[ 5 ] - documentHeight + 10)}, 1000 );
});

$(document).on('click','#six',function () {
    $('html, body').animate({ scrollTop: (positions[ 6 ] - documentHeight + 10)}, 1000 );
});

$(document).on('click','#seven',function () {
    $('html, body').animate({ scrollTop: (positions[ 7 ] - documentHeight + 10)}, 1000 );
});
